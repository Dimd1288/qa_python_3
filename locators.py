...
class ProfilePageLocators:
    EXIT_PROFILE_BUTTON = By.XPATH, "//button[text()='Выход']"  # Кнопка выхода в профиле пользователя
    PROFILE_LOGIN_INPUT = By.XPATH, "//label[text()='Логин']/following-sibling::input"  # Логин пользователя
